...
/**
 * PageExtension - Manages document page functionality
 * 
 * Features:
 * - Page creation and management
 * - Automatic page layout calculations
 * - Page numbering and margins
 * - Unique ID generation for page elements
 * - Default configuration values for all settings
 * - Automatic CSS injection for self-contained styling
 */
...
// Node types that support page functionality
    ...
    return {
      recomputeComputedHtml:
        ...
        ({ editor }) => {
          ...
          // Trigger page split after a delay to ensure HTML is built
          setTimeout(() => {
