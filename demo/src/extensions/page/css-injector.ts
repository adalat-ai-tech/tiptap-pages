/**
 * CSS Injector for PageExtension
 * Automatically injects page extension styles when the extension is added
 */
...
/**
 * CSS content for the PageExtension
 * This contains all the necessary styles for pages, headers, footers, etc.
 */
const PAGE_EXTENSION_CSS = `
/* PageExtension Styles - Automatically injected when extension is added */

/* Page styling - A4 dimensions and professional appearance */
.Page {
  background: white;
...
/**
 * Inject the PageExtension CSS into the document head
 * This ensures styles are available as soon as the extension is added
 */
...
/**
 * Remove the PageExtension CSS from the document
 * Useful for cleanup when the extension is removed
 */
...
/**
 * Check if PageExtension styles are currently injected
 */
